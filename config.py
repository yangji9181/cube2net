...
def parse_args():
	...
	parser.add_argument('--trajectory_length', type=int, default=40, help=None)
	parser.add_argument('--epoch', type=int, default=80, help=None)
	parser.add_argument('--outer_step', type=int, default=100, help='Number of rounds of mini batch SGD per epoch')
	parser.add_argument('--step', type=int, default=2, help=None)
	parser.add_argument('--low_limit', type=int, default=14, help=None)
	parser.add_argument('--high_limit', type=int, default=15, help=None)
