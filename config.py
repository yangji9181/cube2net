...
def parse_args():
	...
	parser.add_argument('--trajectory_length', type=int, default=80, help=None)
	...
	parser.add_argument('--low_limit', type=int, default=0, help=None)
	parser.add_argument('--high_limit', type=int, default=1, help=None)
